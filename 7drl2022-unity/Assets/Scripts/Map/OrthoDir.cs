...
public enum OrthoDir {
    [OrthoDir("North",     0, -1,  0,      0,  0,  1,      1)] North,
    [OrthoDir("East",      1,  0,  0,      1,  0,  0,      0)] East,
    [OrthoDir("South",     0,  1,  0,      0,  0, -1,      3)] South,
    [OrthoDir("West",     -1,  0,  0,     -1,  0,  0,      2)] West,
}
...
public static class OrthoDirExtensions {
    ...
    public static OrthoDir Inverse(this OrthoDir dir) {
        switch (dir) {
            case OrthoDir.East:     return OrthoDir.West;
            case OrthoDir.West:     return OrthoDir.East;
            case OrthoDir.North:    return OrthoDir.South;
            case OrthoDir.South:    return OrthoDir.North;
